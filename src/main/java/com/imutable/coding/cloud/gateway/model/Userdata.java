package com.imutable.coding.cloud.gateway.model;
...
public class Userdata implements UserDetails {
    ...
    public Userdata(Long id, String firstName, String lastName, String password, String email, String address, List<String> roles, String mobile ) {
        this.id = id;
